...
void CsssDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CsssDoc::InitializeSearchContent()
{
...
void CsssDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
